...
function Hamburger(bunType, garnish, cheese, sauce, meatPatty, pattyNum, topping){
    ...
    this.description = function () {
        return `Your Order is a ${this.bunType}, with ${this.garnish}, ${this.cheese}
        , ${this.sauce}, ${this.meatPatty}, ${this.pattyNum} and ${this.topping}.`;
    };
}

let burger1 = new Hamburger("Sesame Bun", "Lettuce", "Chedder", "Ketchup","Chicken", "Double Patty", "Pickles");
output2.textContent = burger1.description();
